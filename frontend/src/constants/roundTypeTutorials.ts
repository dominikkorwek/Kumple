...
export const ROUND_TYPE_TUTORIALS: Record<RoundType, RoundTypeTutorialContent> = {
  ...
  REUSE_QUESTION: {
    ...
    steps: [
      'Losowe pytanie trafia do wybranego gracza.',
      'Gracz wpisuje 3 fałszywe i 1 prawdziwą odpowiedź, potem wskazuje swoją.',
      'Reszta grupy zgaduje, która opcja jest prawdziwa.',
    ],
  },
  VOTE_PERSON: {
