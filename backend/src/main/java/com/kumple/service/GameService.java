...
import com.kumple.repository.RoundBriefingAckRepository;
...
public class GameService {
    ...
    private final RoundBriefingAckRepository roundBriefingAckRepository;
    ...
    public GameService(
            ...
            RoundBriefingAckRepository roundBriefingAckRepository
    ) {
        ...
        this.roundBriefingAckRepository = roundBriefingAckRepository;
    }
    ...
    private GameSession resetFinishedSession(GameSession session) {
        roundBriefingAckRepository.deleteByRoundGameSessionId(session.getId());
